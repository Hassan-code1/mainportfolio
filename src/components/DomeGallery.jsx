          ...
          <div className="stage">
            <div ref={sphereRef} className="sphere">
              {items.map((it, i) => (
                ...
                >
                  <div
                    className="item__image absolute block overflow-hidden cursor-pointer transition-transform duration-300 flex flex-col items-center justify-center shadow-lg"
                    role="button"
                    tabIndex={0}
                  ...
                  >
                    ...
                    />
                    <span className="text-[#EDEDED] font-semibold text-xs text-center pointer-events-none px-2">{it.alt}</span>
                  </div>
                </div>
              ))}
            </div>
